...
namespace Movit.Util.Log
{
    ...
    public class LogFormat
    {
        ...
        /// <param name="logMessage">对象</param>
        /// <returns></returns>
        public string InterfaceFormat(LogMessage logMessage)
        {
            StringBuilder strInfo = new StringBuilder();
            strInfo.Append("1. 请求地址: " + logMessage.Url + "    \r\n");
            strInfo.Append("2. Ip  : " + logMessage.Ip + "   主机: " + logMessage.Host + "\r\n");
            strInfo.Append("3. 请求内容: " + Str.Insert(logMessage.RemarkOne, 50, "\r\n") + "\r\n");
            strInfo.Append("4. 返回内容: " + Str.Insert(logMessage.RemarkTwo, 50, "\r\n") + "\r\n");
            strInfo.Append("-------------------------------------------------------------------------------\r\n");
            return strInfo.ToString();
        }
