...
namespace Movit.Application.IService.BaseManage
{
    ...
    public interface IUserService
    {
        ...
        /// </summary>
        /// <returns></returns>
        DataTable GetTable(Pagination pagination, string orgId, string keyQueryValue);
        /// <summary>
        /// 用户列表
        /// </summary>
        /// <returns></returns>
        ...
        /// <returns></returns>
        IEnumerable<UserModel> GetUserModelPageList(Pagination pagination, string queryJson);
        /// <summary>
        /// 用户列表（ALL）
        /// </summary>
        /// <returns></returns>
        ...
        User_View GetUserViewEntity(string LoginName);
        /// <summary>
        /// 导出用户列表
        /// </summary>
        /// <returns></returns>
