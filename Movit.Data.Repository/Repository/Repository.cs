...
namespace Movit.Data.Repository
{
    ...
    public class Repository : IRepository
    {
        ...
        public int Insert<T>(List<T> entity) where T : class,new()
        {
            return db.Insert<T>(entity);
        }
        ...
        public int Delete<T>(List<T> entity) where T : class,new()
        {
            return db.Delete<T>(entity);
        }
        ...
        public int Update<T>(List<T> entity) where T : class,new()
        {
            return db.Update<T>(entity);
        }
        ...
        {
            return db.Update<T>(entities, UpdateColumns, NullUpdate);
        }
        #endregion
        ...
        public IEnumerable<T> FindList<T>(string strSql, DbParameter[] dbParameter, Pagination pagination) where T : class,new()
        {
            int total = pagination.records;
        ...
        public DataTable FindTable(string strSql, Pagination pagination)
        {
            ...
            string ascstr = pagination.sord == null ? " asc" : pagination.sord.ToLower();

            var data = db.FindTable(strSql, pagination.sidx, ascstr == "asc" ? true : false, pagination.rows, pagination.page, out total);
            pagination.records = total;
            return data;
        }
