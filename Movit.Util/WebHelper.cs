...
namespace Movit.Util
{
    ...
    public static class WebHelper
    {
        ...
        public static void WriteCookie(string strName, string strValue)
        {
            ...
            //var cookieExpires = Config.GetValue("LoginCookieExpires").ToInt();//cookie有效时间 单位：小时
            cookie.Expires = DateTime.Now.AddYears(5); //DateTime.Now.AddDays(2);//TODO ivan.yao 20180709 这里先默认给他加上2天 后期写成配置项
