...
namespace Movit.Util
{
    ...
    public class Time
    {
        ...
        /// <returns></returns>
        public static DateTime GetFirstDayOfMonth(DateTime? _currentTime = null)
        {

            var currentTime = DateTime.Now;
            if (_currentTime != null)
            {
                currentTime = _currentTime ?? currentTime;
        ...
        /// <param name="_currentTime"></param>
        /// <returns></returns>
        public static bool IsFirstDayOfMonth(DateTime? _currentTime = null)
        {

            var date = GetFirstDayOfMonth(_currentTime).ToShortDateString();
            var currentDate = DateTime.Now.ToShortDateString().ToString();
        ...
        /// <param name="_currentTime"></param>
        /// <returns></returns>
        public static DateTime GetLastDayOfMonth(DateTime? _currentTime = null)
        {
            ...
            var currenFirstDayOfMonth = GetFirstDayOfMonth(currentTime);

            return currenFirstDayOfMonth.AddMonths(1).AddDays(-1);
        }
        #endregion
        #region  当天是否当月是最后一天
        /// <summary>
        ...
        /// <param name="_currentTime"></param>
        /// <returns></returns>
        public static bool IsLastDayOfMonth(DateTime? _currentTime = null)
        {
        ...
        /// <param name="_currentTime"></param>
        /// <returns></returns>
        public static bool IsFirstDayOfYear(DateTime? _currentTime = null)
        {
            var currentTime = DateTime.Now;
            if (_currentTime != null)
            {
            ...
            var firstDayOfYear = currentTime.AddMonths(-currentTime.Month + 1).AddDays(-currentTime.Day + 1).ToShortDateString();
            var currentDate = DateTime.Now.ToShortDateString().ToString();
            return firstDayOfYear == currentDate;
        }
        ...
        /// <param name="_currentTime"></param>
        /// <returns></returns>
        public static bool IsLastDayOfYear(DateTime? _currentTime = null)
        {
            var currentTime = DateTime.Now;
            if (_currentTime != null)
            {
            ...
            var firstDayOfYear = currentTime.AddMonths(-currentTime.Month + 1).AddDays(-currentTime.Day + 1);
            var dtLastDay = firstDayOfYear.AddYears(1).AddDays(-1).ToShortDateString();
            var currentDate = DateTime.Now.ToShortDateString().ToString();
            return dtLastDay == currentDate;
        }
