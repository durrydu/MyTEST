...
namespace Movit.Util
{
    ...
    public static class EnumHelper
    {
        ...
        /// <returns></returns>
        public static List<EnumDescription> ToDescriptionList<TEnum>(bool needInit = false, int initId = -1, string initDes = "==全部==")
        {
        ...
        /// <param name="enumObj"></param>
        /// <returns></returns>
        public static Dictionary<int, string> ToDescriptionDictionary<TEnum>(bool needInit = false, int initId = -1, string initDes = "==全部==")
        {
            Type type = typeof(TEnum);
            var values = Enum.GetValues(type);
        ...
        /// <param name="enumObj"></param>
        /// <returns></returns>
        public static Dictionary<int, string> ToDictionary<TEnum>(bool needInit = false, int initId = -1, string initName = "==全部==")
        {
            Type type = typeof(TEnum);
            var values = Enum.GetValues(type);
            var enums = new Dictionary<int, string>();
