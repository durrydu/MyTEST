    ...
    public class MultiTable
    {
        ...
        public string EntityBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> gridColumnModel, bool isChildTable)
        {
            ...
            try
            {
                ...
                sb.Append("namespace Movit.Application.Entity." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
                sb.Append("    /// Copyright (c) 2013-2016  \r\n");
                ...
                if (isChildTable)
                {
                    sb.Append("    public class " + multiTableConfigModel.ChildTableName + "Entity  \r\n");
                }
                else
                {
                    sb.Append("    public class " + multiTableConfigModel.EntityClassName + "  \r\n");
                }
                sb.Append("    {\r\n");
        ...
        public string EntityMapBuilder(MultiTableConfigModel multiTableConfigModel, bool isChildTable)
        {
            try
            {
                ...
                StringBuilder sb = new StringBuilder();
                sb.Append("using Movit.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
                sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

                sb.Append("namespace Movit.Application.Mapping." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
                sb.Append("    /// Copyright (c) 2013-2016  \r\n");
        ...
        public string ServiceBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> colModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Movit.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Movit.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            ...
            sb.Append("using Movit.Util.Extension;\r\n\r\n");

            sb.Append("namespace Movit.Application.Service." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    ///  \r\n");
            sb.Append("    /// Copyright (c) 2013-2016  \r\n");
        ...
        public string IServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("namespace Movit.Application.IService." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    ///  \r\n");
            sb.Append("    /// Copyright (c) 2013-2016  \r\n");
        ...
        public string BusinesBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("using Movit.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Movit.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Movit.Application.Service." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Movit.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace Movit.Application.Busines." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    ///  \r\n");
            sb.Append("    /// Copyright (c) 2013-2016  \r\n");
        ...
        public string ControllerBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Movit.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Movit.Application.Busines." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using Movit.Util;\r\n");
            sb.Append("using Movit.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace Movit.Application.Web.Areas." + multiTableConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    ///  \r\n");
            sb.Append("    /// Copyright (c) 2013-2016  \r\n");
