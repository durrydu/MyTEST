using Movit.CodeGenerator.Comm;
using Movit.CodeGenerator.Model;
using Movit.Util;
using System;
...
namespace Movit.CodeGenerator.Template
{
    /// <summary>
    ///  
    ...
    public class SingleTable
    {
        ...
        public string EntityBuilder(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.Append("using Movit.Application.Code;\r\n\r\n");
            sb.Append("using SqlSugar;\r\n");
            sb.Append("namespace Movit.Application.Entity\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
            sb.Append("    /// Copyright (c) 2013-2018 盟拓软件(苏州)\r\n");
            ...
            sb.Append("    /// </summary>\r\n");
            sb.Append("     [SugarTable(\"" + baseConfigModel.Description + "\")]\r\n");
            sb.Append("    public class " + baseConfigModel.EntityClassName + "\r\n");
            sb.Append("    {\r\n");
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                foreach (DataRow rowItem in dt.Rows)
                {
                    ...
                    if (IsPrimaryKey)
                    {
                        sb.Append("     [SugarColumn(IsPrimaryKey = true)] //是主键\r\n");
                        IsPrimaryKey = false;
                    }
            ...
            sb.Append("        public  void Modify(string keyValue)\r\n");
            sb.Append("        {\r\n");
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Movit.Application.Entity;\r\n");
            sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

            sb.Append("namespace Movit.Application.Mapping\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
            sb.Append("    /// Copyright (c) 2013-2018 盟拓\r\n");
            sb.Append("    /// 创 建：" + baseConfigModel.CreateUser + "\r\n");
            sb.Append("    /// 日 期：" + baseConfigModel.CreateDate + "\r\n");
            sb.Append("    /// 描 述：" + baseConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
        ...
        public string ServiceBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Movit.Application.Entity;\r\n");
            sb.Append("using Movit.Application.IService;\r\n");
            sb.Append("using Movit.Data.Repository;\r\n");
            sb.Append("using Movit.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Linq;\r\n\r\n");

            sb.Append("namespace Movit.Application.Service\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    ///  \r\n");
            sb.Append("    /// Copyright (c) 2015-201盟拓软件(苏州)\r\n");
            sb.Append("    /// 创 建：" + baseConfigModel.CreateUser + "\r\n");
            sb.Append("    /// 日 期：" + baseConfigModel.CreateDate + "\r\n");
            sb.Append("    /// 描 述：" + baseConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
            ...
            sb.Append("          {\r\n");
            sb.Append("            throw new Exception(ex.Message);\r\n");
            sb.Append("          }\r\n");
            sb.Append("        }\r\n");
            sb.Append("        /// <summary>\r\n");
            ...
            sb.Append("        /// 批量插入\r\n");
            sb.Append("        /// </summary>\r\n");
            sb.Append("        /// <param name=\"entityList\">实体对象</param>\r\n");
            sb.Append("        /// <returns></returns>\r\n");
            sb.Append("        public void BatchInsert(List<" + baseConfigModel.EntityClassName + "> entityList)\r\n");
            sb.Append("        {\r\n");
            sb.Append("         try\r\n");
            sb.Append("         {\r\n");
            sb.Append("                this.BaseRepository().Insert(entityList);\r\n");
            sb.Append("         }\r\n");
            sb.Append("         catch (Exception ex)\r\n");
            sb.Append("          {\r\n");
            sb.Append("            throw new Exception(ex.Message);\r\n");
            ...
            sb.Append("        /// <param name=\"entityList\">实体对象</param>\r\n");
            sb.Append("        /// <returns></returns>\r\n");
            sb.Append("        public void BatchUpdate(List<" + baseConfigModel.EntityClassName + "> entityList)\r\n");
            sb.Append("        {\r\n");
            sb.Append("         try\r\n");
            sb.Append("         {\r\n");
            sb.Append("                this.BaseRepository().Update(entityList);\r\n");
            sb.Append("         }\r\n");
            sb.Append("         catch (Exception ex)\r\n");
            sb.Append("          {\r\n");
            sb.Append("            throw new Exception(ex.Message);\r\n");
        ...
        public string IServiceBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("namespace Movit.Application.IService\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    ///  \r\n");
            sb.Append("    /// Copyright (c) 2013-201盟拓软件(苏州)\r\n");
            sb.Append("    /// 创 建：" + baseConfigModel.CreateUser + "\r\n");
            sb.Append("    /// 日 期：" + baseConfigModel.CreateDate + "\r\n");
            sb.Append("    /// 描 述：" + baseConfigModel.Description + "\r\n");
            sb.Append("    /// </summary>\r\n");
            ...
            sb.Append("        /// 批量插入\r\n");
            sb.Append("        /// </summary>\r\n");
            sb.Append("        /// <param name=\"entityList\">实体对象List</param>\r\n");
            sb.Append("        /// <returns></returns>\r\n");
            sb.Append("        void BatchInsert(List<" + baseConfigModel.EntityClassName + "> entityList);\r\n");
            sb.Append("        /// <summary>\r\n");
            sb.Append("        /// 批量更更新\r\n");
            sb.Append("        /// </summary>\r\n");
            sb.Append("        /// <param name=\"entityList\">实体对象List</param>\r\n");
            sb.Append("        /// <returns></returns>\r\n");
            sb.Append("        void BatchUpdate(List<" + baseConfigModel.EntityClassName + "> entityList);\r\n");
            sb.Append("        #endregion\r\n");
            sb.Append("    }\r\n");
            sb.Append("}\r\n");
            return sb.ToString();
        ...
        public string BusinesBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("using Movit.Application.Entity;\r\n");
            sb.Append("using Movit.Application.IService;\r\n");
            sb.Append("using Movit.Application.Service;\r\n");
            sb.Append("using Movit.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace Movit.Application.Busines\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    ///  \r\n");
            sb.Append("    /// Copyright (c) 2013-201盟拓软件(苏州)\r\n");
            ...
            sb.Append("            try\r\n");
            sb.Append("            {\r\n");
            sb.Append("                service.BatchInsert(entityList);\r\n");
            sb.Append("            }\r\n");
            sb.Append("            catch (Exception ex)\r\n");
            sb.Append("            {\r\n");
            sb.Append("                throw new Exception(ex.Message);\r\n");
            ...
            sb.Append("            try\r\n");
            sb.Append("            {\r\n");
            sb.Append("                service.BatchUpdate(entityList);\r\n");
            sb.Append("            }\r\n");
            sb.Append("            catch (Exception ex)\r\n");
            sb.Append("            {\r\n");
            sb.Append("                throw new Exception(ex.Message);\r\n");
        ...
        public string ControllerBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using Movit.Application.Entity;\r\n");
            sb.Append("using Movit.Application.Busines;\r\n");
            sb.Append("using Movit.Util;\r\n");
            sb.Append("using Movit.Util.WebControl;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace Movit.Application.Web.Areas." + baseConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    ///  \r\n");
            sb.Append("    /// Copyright (c) 2013-201盟拓软件(苏州)\r\n");
